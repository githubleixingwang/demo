...
public class ReadTest {
    ...
    public void simpleRead() {
        ...
        // since: 3.0.0-beta1
        String fileName = TestFileUtil.getPath()  + File.separator + "easyexcel" + File.separator + "demo" + File.separator + "demo.xlsx";
        ...
        fileName = TestFileUtil.getPath()  + File.separator + "easyexcel" + File.separator + "demo" + File.separator + "demo.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet 文件流会自动关闭
    ...
    public void converterRead() {
        ...
        EasyExcel.read(fileName, ConverterData.class, new ConverterDataListener())
                // 这里注意 我们也可以registerConverter来指定自定义转换器， 但是这个转换变成全局了， 所有java为string,excel为string的都会用这个转换器。优先使用字段方式
